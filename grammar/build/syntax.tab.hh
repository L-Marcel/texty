...
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_BYTE(uint8_t v) {
    return symbol_type(token::BYTE, std::move(v));
  }
#else
  static symbol_type make_BYTE(const uint8_t& v) {
    return symbol_type(token::BYTE, v);
  }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_INT(int32_t v) {
    return symbol_type(token::INT, std::move(v));
  }
#else
  static symbol_type make_INT(const int32_t& v) {
    return symbol_type(token::INT, v);
  }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_LONG(int64_t v) {
    return symbol_type(token::LONG, std::move(v));
  }
#else
  static symbol_type make_LONG(const int64_t& v) {
    return symbol_type(token::LONG, v);
  }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_FLOAT(float v) {
    return symbol_type(token::FLOAT, std::move(v));
  }
#else
  static symbol_type make_FLOAT(const float& v) {
    return symbol_type(token::FLOAT, v);
  }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_DOUBLE(double v) {
    return symbol_type(token::DOUBLE, std::move(v));
  }
#else
  static symbol_type make_DOUBLE(const double& v) {
    return symbol_type(token::DOUBLE, v);
  }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_BOOL(bool v) {
    return symbol_type(token::BOOL, std::move(v));
  }
#else
  static symbol_type make_BOOL(const bool& v) {
    return symbol_type(token::BOOL, v);
  }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_ID(std::string v) {
    return symbol_type(token::ID, std::move(v));
  }
#else
  static symbol_type make_ID(const std::string& v) {
    return symbol_type(token::ID, v);
  }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_NAME(std::string v) {
    return symbol_type(token::NAME, std::move(v));
  }
#else
  static symbol_type make_NAME(const std::string& v) {
    return symbol_type(token::NAME, v);
  }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_CONST_NAME(std::string v) {
    return symbol_type(token::CONST_NAME, std::move(v));
  }
#else
  static symbol_type make_CONST_NAME(const std::string& v) {
    return symbol_type(token::CONST_NAME, v);
  }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_STRING(std::string v) {
...
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_CHAR(char v) {
    return symbol_type(token::CHAR, std::move(v));
  }
#else
  static symbol_type make_CHAR(const char& v) {
    return symbol_type(token::CHAR, v);
  }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_TYPE_BYTE(Type v) {
    return symbol_type(token::TYPE_BYTE, std::move(v));
  }
#else
  static symbol_type make_TYPE_BYTE(const Type& v) {
    return symbol_type(token::TYPE_BYTE, v);
  }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_TYPE_INT(Type v) {
    return symbol_type(token::TYPE_INT, std::move(v));
  }
#else
  static symbol_type make_TYPE_INT(const Type& v) {
    return symbol_type(token::TYPE_INT, v);
  }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_TYPE_LONG(Type v) {
    return symbol_type(token::TYPE_LONG, std::move(v));
  }
#else
  static symbol_type make_TYPE_LONG(const Type& v) {
    return symbol_type(token::TYPE_LONG, v);
  }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_TYPE_FLOAT(Type v) {
    return symbol_type(token::TYPE_FLOAT, std::move(v));
  }
#else
  static symbol_type make_TYPE_FLOAT(const Type& v) {
    return symbol_type(token::TYPE_FLOAT, v);
  }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_TYPE_DOUBLE(Type v) {
    return symbol_type(token::TYPE_DOUBLE, std::move(v));
  }
#else
  static symbol_type make_TYPE_DOUBLE(const Type& v) {
    return symbol_type(token::TYPE_DOUBLE, v);
  }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_TYPE_BOOL(Type v) {
    return symbol_type(token::TYPE_BOOL, std::move(v));
  }
#else
  static symbol_type make_TYPE_BOOL(const Type& v) {
    return symbol_type(token::TYPE_BOOL, v);
  }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_TYPE_STRING(Type v) {
    return symbol_type(token::TYPE_STRING, std::move(v));
  }
#else
  static symbol_type make_TYPE_STRING(const Type& v) {
    return symbol_type(token::TYPE_STRING, v);
  }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_TYPE_CHAR(Type v) {
    return symbol_type(token::TYPE_CHAR, std::move(v));
  }
#else
  static symbol_type make_TYPE_CHAR(const Type& v) {
    return symbol_type(token::TYPE_CHAR, v);
  }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_TYPE_POINTER(Type v) {
    return symbol_type(token::TYPE_POINTER, std::move(v));
  }
#else
  static symbol_type make_TYPE_POINTER(const Type& v) {
    return symbol_type(token::TYPE_POINTER, v);
  }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_TYPE_OPTION(Type v) {
    return symbol_type(token::TYPE_OPTION, std::move(v));
  }
#else
  static symbol_type make_TYPE_OPTION(const Type& v) {
    return symbol_type(token::TYPE_OPTION, v);
  }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_DECREMENT() { return symbol_type(token::DECREMENT); }
#else
  static symbol_type make_DECREMENT() { return symbol_type(token::DECREMENT); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_INCREMENT() { return symbol_type(token::INCREMENT); }
#else
  static symbol_type make_INCREMENT() { return symbol_type(token::INCREMENT); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_EXP() { return symbol_type(token::EXP); }
#else
  static symbol_type make_EXP() { return symbol_type(token::EXP); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_EQ() { return symbol_type(token::EQ); }
#else
  static symbol_type make_EQ() { return symbol_type(token::EQ); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_AND_ATTR() { return symbol_type(token::AND_ATTR); }
#else
  static symbol_type make_AND_ATTR() { return symbol_type(token::AND_ATTR); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_OR_ATTR() { return symbol_type(token::OR_ATTR); }
#else
  static symbol_type make_OR_ATTR() { return symbol_type(token::OR_ATTR); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_LAZY_AND_ATTR() {
...
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_LAZY_OR_ATTR() {
...
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_MOD_ATTR() { return symbol_type(token::MOD_ATTR); }
#else
  static symbol_type make_MOD_ATTR() { return symbol_type(token::MOD_ATTR); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_XOR_ATTR() { return symbol_type(token::XOR_ATTR); }
#else
  static symbol_type make_XOR_ATTR() { return symbol_type(token::XOR_ATTR); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_PLUS_ATTR() { return symbol_type(token::PLUS_ATTR); }
#else
  static symbol_type make_PLUS_ATTR() { return symbol_type(token::PLUS_ATTR); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_CONCAT_ATTR() {
...
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_MINUS_ATTR() {
...
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_MULT_ATTR() { return symbol_type(token::MULT_ATTR); }
#else
  static symbol_type make_MULT_ATTR() { return symbol_type(token::MULT_ATTR); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_DIV_ATTR() { return symbol_type(token::DIV_ATTR); }
#else
  static symbol_type make_DIV_ATTR() { return symbol_type(token::DIV_ATTR); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_AND() { return symbol_type(token::AND); }
#else
  static symbol_type make_AND() { return symbol_type(token::AND); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_OR() { return symbol_type(token::OR); }
#else
  static symbol_type make_OR() { return symbol_type(token::OR); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_REF() { return symbol_type(token::REF); }
#else
  static symbol_type make_REF() { return symbol_type(token::REF); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_BAR() { return symbol_type(token::BAR); }
#else
  static symbol_type make_BAR() { return symbol_type(token::BAR); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_NOT_EQ() { return symbol_type(token::NOT_EQ); }
#else
  static symbol_type make_NOT_EQ() { return symbol_type(token::NOT_EQ); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_LT_EQ() { return symbol_type(token::LT_EQ); }
#else
  static symbol_type make_LT_EQ() { return symbol_type(token::LT_EQ); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_GT_EQ() { return symbol_type(token::GT_EQ); }
#else
  static symbol_type make_GT_EQ() { return symbol_type(token::GT_EQ); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_LT() { return symbol_type(token::LT); }
#else
  static symbol_type make_LT() { return symbol_type(token::LT); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_GT() { return symbol_type(token::GT); }
#else
  static symbol_type make_GT() { return symbol_type(token::GT); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_NOT() { return symbol_type(token::NOT); }
#else
  static symbol_type make_NOT() { return symbol_type(token::NOT); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_REV() { return symbol_type(token::REV); }
#else
  static symbol_type make_REV() { return symbol_type(token::REV); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_MOD() { return symbol_type(token::MOD); }
#else
  static symbol_type make_MOD() { return symbol_type(token::MOD); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_XOR() { return symbol_type(token::XOR); }
#else
  static symbol_type make_XOR() { return symbol_type(token::XOR); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_ATTR() { return symbol_type(token::ATTR); }
#else
  static symbol_type make_ATTR() { return symbol_type(token::ATTR); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_MINUS() { return symbol_type(token::MINUS); }
#else
  static symbol_type make_MINUS() { return symbol_type(token::MINUS); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_PLUS() { return symbol_type(token::PLUS); }
#else
  static symbol_type make_PLUS() { return symbol_type(token::PLUS); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_MULT() { return symbol_type(token::MULT); }
#else
  static symbol_type make_MULT() { return symbol_type(token::MULT); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_DIV() { return symbol_type(token::DIV); }
#else
  static symbol_type make_DIV() { return symbol_type(token::DIV); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_NEW() { return symbol_type(token::NEW); }
#else
  static symbol_type make_NEW() { return symbol_type(token::NEW); }
#endif
#if 201103L <= YY_CPLUSPLUS
...
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_CONST() { return symbol_type(token::CONST); }
#else
  static symbol_type make_CONST() { return symbol_type(token::CONST); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_RANGE() { return symbol_type(token::RANGE); }
#else
  static symbol_type make_RANGE() { return symbol_type(token::RANGE); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_DOT() { return symbol_type(token::DOT); }
#else
  static symbol_type make_DOT() { return symbol_type(token::DOT); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_COMMA() { return symbol_type(token::COMMA); }
#else
  static symbol_type make_COMMA() { return symbol_type(token::COMMA); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_COLON() { return symbol_type(token::COLON); }
#else
  static symbol_type make_COLON() { return symbol_type(token::COLON); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_DOUBLE_COLON() {
...
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_SEMICOLON() { return symbol_type(token::SEMICOLON); }
#else
  static symbol_type make_SEMICOLON() { return symbol_type(token::SEMICOLON); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_LEFT_PAREN() {
...
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_RIGHT_PAREN() {
...
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_LEFT_BRACKET() {
...
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_RIGHT_BRACKET() {
...
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_LEFT_BRACE() {
...
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_RIGHT_BRACE() {
...
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_IF() { return symbol_type(token::IF); }
#else
  static symbol_type make_IF() { return symbol_type(token::IF); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_END_IF() { return symbol_type(token::END_IF); }
#else
  static symbol_type make_END_IF() { return symbol_type(token::END_IF); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_THEN() { return symbol_type(token::THEN); }
#else
  static symbol_type make_THEN() { return symbol_type(token::THEN); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_ELIF() { return symbol_type(token::ELIF); }
#else
  static symbol_type make_ELIF() { return symbol_type(token::ELIF); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_ELSE() { return symbol_type(token::ELSE); }
#else
  static symbol_type make_ELSE() { return symbol_type(token::ELSE); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_FOR() { return symbol_type(token::FOR); }
#else
  static symbol_type make_FOR() { return symbol_type(token::FOR); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_WHILE() { return symbol_type(token::WHILE); }
#else
  static symbol_type make_WHILE() { return symbol_type(token::WHILE); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_END_WHILE() { return symbol_type(token::END_WHILE); }
#else
  static symbol_type make_END_WHILE() { return symbol_type(token::END_WHILE); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_REPEAT() { return symbol_type(token::REPEAT); }
#else
  static symbol_type make_REPEAT() { return symbol_type(token::REPEAT); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_UNTIL() { return symbol_type(token::UNTIL); }
#else
  static symbol_type make_UNTIL() { return symbol_type(token::UNTIL); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_END_FOR() { return symbol_type(token::END_FOR); }
#else
  static symbol_type make_END_FOR() { return symbol_type(token::END_FOR); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_BREAK() { return symbol_type(token::BREAK); }
#else
  static symbol_type make_BREAK() { return symbol_type(token::BREAK); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_CONTINUE() { return symbol_type(token::CONTINUE); }
#else
  static symbol_type make_CONTINUE() { return symbol_type(token::CONTINUE); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_SWITCH() { return symbol_type(token::SWITCH); }
#else
  static symbol_type make_SWITCH() { return symbol_type(token::SWITCH); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_CASE() { return symbol_type(token::CASE); }
#else
  static symbol_type make_CASE() { return symbol_type(token::CASE); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_DEFAULT() { return symbol_type(token::DEFAULT); }
#else
  static symbol_type make_DEFAULT() { return symbol_type(token::DEFAULT); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_END_SWITCH() {
...
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_IN() { return symbol_type(token::IN); }
#else
  static symbol_type make_IN() { return symbol_type(token::IN); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_SOME() { return symbol_type(token::SOME); }
#else
  static symbol_type make_SOME() { return symbol_type(token::SOME); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_NONE() { return symbol_type(token::NONE); }
#else
  static symbol_type make_NONE() { return symbol_type(token::NONE); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_FUNCTION() { return symbol_type(token::FUNCTION); }
#else
  static symbol_type make_FUNCTION() { return symbol_type(token::FUNCTION); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_END_FUNCTION() {
...
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_PROCEDURE() { return symbol_type(token::PROCEDURE); }
#else
  static symbol_type make_PROCEDURE() { return symbol_type(token::PROCEDURE); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_END_PROCEDURE() {
...
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_ENUM() { return symbol_type(token::ENUM); }
#else
  static symbol_type make_ENUM() { return symbol_type(token::ENUM); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_END_ENUM() { return symbol_type(token::END_ENUM); }
#else
  static symbol_type make_END_ENUM() { return symbol_type(token::END_ENUM); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_STRUCT() { return symbol_type(token::STRUCT); }
#else
  static symbol_type make_STRUCT() { return symbol_type(token::STRUCT); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_END_STRUCT() {
...
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_SELF() { return symbol_type(token::SELF); }
#else
  static symbol_type make_SELF() { return symbol_type(token::SELF); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_IMPL() { return symbol_type(token::IMPL); }
#else
  static symbol_type make_IMPL() { return symbol_type(token::IMPL); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_END_IMPL() { return symbol_type(token::END_IMPL); }
#else
  static symbol_type make_END_IMPL() { return symbol_type(token::END_IMPL); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_TRAIT() { return symbol_type(token::TRAIT); }
#else
  static symbol_type make_TRAIT() { return symbol_type(token::TRAIT); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_END_TRAIT() { return symbol_type(token::END_TRAIT); }
#else
  static symbol_type make_END_TRAIT() { return symbol_type(token::END_TRAIT); }
#endif
#if 201103L <= YY_CPLUSPLUS
  static symbol_type make_RETURN() { return symbol_type(token::RETURN); }
#else
  static symbol_type make_RETURN() { return symbol_type(token::RETURN); }
#endif
...
#line 3511 "grammar/build/syntax.tab.hh"
